...
def run_experiment():
    ...
    print(f"Loading Netflix from {absolute_data_path}")
    ...
    pretrain_path = os.path.join(project_root, "pretrain_checkpoints", "lightgcn_netflix_full.pth")
    ...
    # Save Results
    with open("gnndelete_lightgcn_netflix_results.txt", "w") as f:
