...
def run_experiment():
    ...
    save_path = "gnndelete_lightgcn_yelp.pth"
    ...
    pretrain_path = os.path.join(project_root, "pretrain_checkpoints", "lightgcn_yelp_full.pth")
    ...
    # Save Results
    with open("gnndelete_lightgcn_yelp_results.txt", "w") as f:
