# -*- coding: utf-8 -*-
# LightGCN ML-1M Training Script
...
# Dataset & Config - Explicitly set for ML-1M
DATASET_NAME = "ml-1m"
SAVE_PATH = os.path.join(project_root, "pretrain_checkpoints", f"lightgcn_{DATASET_NAME.replace('-', '')}_full.pth")

# Modified Config for Pre-training alignment
PRETRAIN_CONFIG = {
...
def train(model, dataset, optimizer, batch_size, epochs, norm_adj_matrix, k_list, eval_freq, patience, save_path):
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch % eval_freq == 0:
            ...
            # Use Recall@20 for early stopping
...
if __name__ == "__main__":
    ...
    # CRITICAL: Use same split parameters as UnlearnRec
