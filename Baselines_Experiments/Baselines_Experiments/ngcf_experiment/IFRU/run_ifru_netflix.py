...
from data import NetflixDataset
...
def main():
    ...
    dataset = NetflixDataset(root=os.path.join(project_root, "dataset"))
    ...
    # 3. Pretrain
    model_path = os.path.join(project_root, "pretrain_checkpoints", "ngcf_netflix_full.pth")
    ...
    # Increased scale for Netflix as 0.1 was too conservative (dataset is stiffer)
