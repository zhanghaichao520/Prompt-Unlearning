...
if __name__ == "__main__":
    ...
    save_path = "gnndelete_netflix.pth"
    ...
    pretrain_path = os.path.join(project_root, "pretrain_checkpoints", "ngcf_netflix_full.pth")
    ...
    # Save Results
    with open("gnndelete_netflix_results.txt", "w") as f:
