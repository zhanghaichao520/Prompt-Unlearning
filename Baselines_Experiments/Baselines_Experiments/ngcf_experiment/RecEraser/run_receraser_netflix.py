...
def main():
    ...
    config = {
        'root': os.path.join(project_root, 'ngcf_experiment', 'RecEraser', 'Netflix_Experiment'),
        'num_shards': 10, 
        'embedding_size': 64,
        'n_layers': 3,
        'lr': 0.001,
    ...
    if rec_eraser.load_checkpoints():
        ...
        # Partition
        pretrained_path = os.path.join(project_root, 'pretrain_checkpoints', 'ngcf_netflix_full.pth')
    ...
    # Save Results
    with open("receraser_netflix_results.txt", "w") as f:
